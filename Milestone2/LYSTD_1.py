...
##CHANGED THE MIC_OFFSET###########################################
MIC_OFFSET = 1530       # ADC reading of microphone for silence
...
##changed beat threshold from 1.8 to 2 and silence from 1.3 to 1.4####################
BEAT_THRESHOLD = 2      # threshold for c to indicate a beat

SILENCE_THRESHOLD = 1.4     # threshold for c to indicate silence
...
while True:             # Main program loop
    if buffer_full:     # semaphore signal from ISR - set if buffer is full
        ...
        ##CHANGED THE BEAT TIMING FOM 500 TO 480ms#################################
        if (pyb.millis()-tic > 480):    # if more than 500ms since last beat
